...
export default function NotificationsMob() {
    ...
    return (
        <div>
            <li onClick={() => setIsModalOpen(true)} style={{ color: isModalOpen ? 'var(--blue-light-color)' : '' }} className="navbar-blok__section__icon navbar-menu__a">Уведомления</li>
            {isModalOpen && (
